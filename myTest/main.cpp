...
void mapTests()
{
	...
	std::cout << "\n-----ITERATOR-----" << std::endl;
	NS::map<TYPE1, TYPE2>::iterator iter = m.begin();
	NS::map<TYPE1, TYPE2>::const_iterator citer(iter);
	std::cout << iter->first << ", " << iter->second << std::endl;
	std::cout << "iter == citer? " << (iter == citer) << std::endl;
	*iter++;
	citer++;
	std::cout << "iter == citer? " << (iter == citer) << std::endl;

	std::cout << "\n-----COMING BACK FROM END-----" << std::endl;
	iter = m.end();
	iter--;
	std::cout << iter->first << ", " << iter->second << std::endl;
